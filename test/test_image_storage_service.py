...
def png_bytes() -> bytes:
    path = Path(tempfile.gettempdir()) / "webchat2api-test-image.png"
...
class FakeWebDAVClient:
    ...
    def test(self) -> dict[str, object]:
        self.put(".webchat2api_webdav_test.txt", b"webchat2api webdav test\n")
        self.delete(".webchat2api_webdav_test.txt")
...
class ImageStorageServiceTests(unittest.TestCase):
    ...
    def test_test_webdav_writes_and_deletes_probe_file(self):
        ...
        self.assertIn(".webchat2api_webdav_test.txt", FakeWebDAVClient.deleted)
